...
var Juegos = require('./app/routes/Juegos');
var Compras = require('./app/routes/Compras');
var NumeroCompras = require('./app/routes/NumeroCompras');
...
app.use('/NumeroCompras', NumeroCompras);
app.use('/users', users);
